...
class GetFilteredFrequencyDatasourceImpl
    implements IGetFilteredFrequencyDatasource {
  @override
  Future<Either<ITneExceptions, List<FrequencyEntity>>> call(
    ...
    try {
      final response = await dio.get(
        '${TneEnvironment.apiUrl}alunos/entrada-saida/aluno/${data.studentId}/escola/${data.schoolId}?dataRegistroInicio=${data.startFilterDate}&dataRegistroFim=${data.finalFilterDate}',
        options: Options(
          headers: {
            "accept": "text/plain",
